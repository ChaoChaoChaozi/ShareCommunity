...
public class User implements Serializable{
	...
	public String toString() {
		return "User [id=" + id + ", user_name=" + user_name + ", user_email=" + user_email + ", user_pwd=" + user_pwd
				+ ", user_cfm_pwd=" + user_cfm_pwd + ", user_nicename=" + user_nicename + ", user_registered_date="
				+ user_registered_date + ", user_status=" + user_status + ", user_avatar=" + user_avatar
				+ ", user_activationKey=" + user_activationKey + ", user_desc=" + user_desc + "]";
	}

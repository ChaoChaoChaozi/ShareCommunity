...
public class Event implements Serializable{
	...
	public void setTags_list(List<?> tags) {
		this.tags = tags;
	}
	...
	public String toString() {
		return "Event [id=" + id + ", object_type=" + object_type + ", object_id=" + object_id + ", ts=" + ts
				+ ", user_id=" + user_id + ", user_name=" + user_name + ", user_avatar=" + user_avatar + ", like_count="
				+ like_count + ", share_count=" + share_count + ", comment_count=" + comment_count + ", title=" + title
				+ ", summary=" + summary + ", content=" + content + ", tags=" + tags + ", tags_str=" + tags_str
				+ ", following_user_id=" + following_user_id + ", following_user_name=" + following_user_name
				+ ", follower_user_id=" + follower_user_id + ", follower_user_name=" + follower_user_name + ", is_like="
				+ is_like + "]";
	}

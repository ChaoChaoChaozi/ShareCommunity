									...
									<div class="imgbox">
										<c:if test="${feed.object_type eq dic.object_type_album }">
											<a href="<c:url value="/album/${feed.object_id }/photos" />">
												<img src="<c:url  value="http://image.share.com/${feed.title }?imageView2/1/w/200/h/200" />" alt="" />
											</a>
										</c:if>
										<c:if test="${feed.object_type eq dic.object_type_post }">
											<a href="<c:url value="/post/${feed.object_id }" />">
												<img src="<c:url  value="http://image.share.com/${feed.content }?imageView2/1/w/200/h/200" />" alt="" />
											</a>
										</c:if>
									</div>
								</c:forEach>

				...
				<div id="rightside">
					<div class="album metas">
						<div class="meta author">
							<a href="<c:url value="/user/${u.id }" />"><img class="ui avatar image" src="<c:url value="http://image.share.com/${u.user_avatar }"/>"></a>
						...
						<div class="ui tiny images meta" id="imgbox">
							<c:forEach items="${album.photos}" var="photo">
								<a href="#"><img src="<c:url value="http://image.share.com/${photo.key }" />" alt="" id="preview_photo_${photo.id }"></a>
							</c:forEach>
						</div>
						<div class="meta tags">

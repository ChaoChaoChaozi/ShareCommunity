	...
	<c:if test="${feed.object_type == dic.object_type_shortpost }">
		<div class="event row" type="spost" object_type="${feed.object_type }" object_id="${feed.object_id }">
		   <div class="label span2">
		     <a href="<c:url value="/user/${feed.user_id }" />"><img src="http://image.share.com/${feed.user_avatar }"></a>
		   </div>
   ...
   <div class="content span6">
     ...
     <div class="extra">
         ...
         <c:if test="${not empty feed.content }">
   		 	<img src="<c:url value="http://image.share.com/${feed.content }${post_cover_thumbnail}"/>" alt="" />
   		 </c:if>
   	</div>
     <div class="extra">
    ...
    <div class="date">
     ...
     <div class="extra images">
       <c:forTokens items="${feed.content }" delims=":" var="img" begin="0" end="2">
       	<a href="<c:url value="/album/${feed.object_id }/photos" />"><img alt="" src="http://image.share.com/${img }${album_thumbnail}"></a>
       </c:forTokens>
     </div>

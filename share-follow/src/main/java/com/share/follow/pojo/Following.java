...
public class Following {
	...
	public String toString() {
		return "Following [id=" + id + ", user_id=" + user_id + ", user_name=" + user_name + ", following_user_id="
				+ following_user_id + ", following_user_name=" + following_user_name + ", ts=" + ts + "]";
	}
